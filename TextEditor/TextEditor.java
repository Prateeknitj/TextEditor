...
class Myeditor extends JFrame implements ActionListener
{
	...
	public Myeditor()
	{
		...
		TIMEDIT.setMnemonic(KeyEvent.VK_T);
		...
		public void actionPerformed(ActionEvent e)
	{
		...
		{
			JOptionPane.showMessageDialog(null, "This is a simple Text Editor application built using Java made by Prateek Jain","About prateekj16Editor",JOptionPane.INFORMATION_MESSAGE);	
	 	}
	}	
...
public static void main(String args[]) {
    ...
    TextEditor background = new TextEditor();
